...
export const MVP_LIMITS = {
    ...
    MAX_FILE_SIZE: 5 * 1024 * 1024,  // 5MB (загальний)
...
// Типи файлів для Products
export const PRODUCT_FILE_TYPES = {
    IMAGE: {
        ALLOWED_TYPES: ['image/jpeg', 'image/png', 'image/jpg', 'image/webp'],
        MAX_SIZE: 3 * 1024 * 1024, // 3MB (менше ніж для cover)
        FOLDER: 'products'
    }
};
...
// ============================================
// WEBSITE-SPECIFIC CONSTANTS
// ============================================

// SEO ліміти для Website
...
/**
 * Перевіряє чи файл має валідний тип
 */
...
/**
 * Перевіряє чи файл не перевищує ліміт розміру
 */
